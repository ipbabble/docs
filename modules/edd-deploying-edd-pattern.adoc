...
= Deploying the Emerging Diseasae Detection pattern
...
<<<<<<< HEAD:modules/edd-deploying-edd-pattern.adoc
=======
...
>>>>>>> d26b3ce43336504b217cd08e3a1b886368fed26e:content/patterns/emerging-disease-detection/getting-started.adoc
